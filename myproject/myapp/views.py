...
from .models import Statut, Brand, Color, Tag, Product, Cart, CartItem, Categorie, Post
...
def activate(request, uidb64, token):
    ...
    if user is not None and default_token_generator.check_token(user, token):
        user.is_active = True
        user.save()
        # Redirige l'utilisateur vers une page de confirmation d'activation
        return render(request, "activation_complete.html")
    else:
        # Redirige l'utilisateur vers une page d'erreur
